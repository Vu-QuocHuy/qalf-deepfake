...
OUTPUT_DIR="${QALF_TEMPORAL_TCN_OUTPUT_DIR:-E:/DeepFakeData/experiments/qalf_ffpp4_effb0_160_8f_texture_sbi_ema_temporal_tcn_v2}"
if [[ "$(uname -s)" == Linux* ]]; then
    OUTPUT_DIR="${QALF_TEMPORAL_TCN_OUTPUT_DIR:-/mnt/e/DeepFakeData/experiments/qalf_ffpp4_effb0_160_8f_texture_sbi_ema_temporal_tcn_v2}"
fi
