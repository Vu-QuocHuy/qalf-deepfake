...
# QALF v2 evaluation on Celeb-DF-v2 with FF++ threshold calibration.
...
CHECKPOINT="${QALF_TEST_CHECKPOINT:-$STORAGE_ROOT/experiments/qalf_v2_ffpp4_effb0_224_10f_freq_ms_ta_sbi_ema/best.pt}"
OUTPUT_DIR="${QALF_TEST_OUTPUT_DIR:-$STORAGE_ROOT/experiments/qalf_v2_ffpp4_effb0_224_10f_freq_ms_ta_sbi_ema_to_celebdf_12f_3clips_mean_tta_ffpp_threshold}"
